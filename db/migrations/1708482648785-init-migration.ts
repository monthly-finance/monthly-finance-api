...
export class InitMigration1708482648785 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "expense_report" ("id" SERIAL NOT NULL, "deletedAt" TIMESTAMP, "forMonth" character varying NOT NULL, "forYear" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, CONSTRAINT "MonthAndYear" UNIQUE ("forMonth", "forYear"), CONSTRAINT "PK_0a85619cfdd593954781a8bce46" PRIMARY KEY ("id"))`);
