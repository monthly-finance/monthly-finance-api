...
export class InitMigration1708575160199 implements MigrationInterface {
    name = 'InitMigration1708575160199'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "income_report" ("id" SERIAL NOT NULL, "deletedAt" TIMESTAMP, "forMonth" character varying NOT NULL, "forYear" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, CONSTRAINT "IncomeReport_MonthAndYear" UNIQUE ("forMonth", "forYear"), CONSTRAINT "PK_e06bd728f480f95876d4add8d23" PRIMARY KEY ("id"))`);
